package com.bit.apps.kanadra.service;
...
import com.bit.apps.kanadra.util.NotificationUtils;
...
public class MyFirebaseMessagingService extends FirebaseMessagingService {
    ...
    private void handleNotification(String title) {
        if (!NotificationUtils.isAppIsInBackground(getApplicationContext())) {
            ...
            notificationUtils.showNotificationMessage(title,title,ts,pushNotification);
